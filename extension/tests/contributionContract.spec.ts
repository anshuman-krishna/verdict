...
// tests/contract/contributionBatch.json, the way both scorers read
// tests/parity/vectors.jsonl, because the two sides disagreeing about field
// names is a failure that shows up only in production: the service was
// rejecting every real batch with a 422 while both suites passed, since
