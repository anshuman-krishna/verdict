...
async function refresh(): Promise<void> {
  ...
  renderPopup(app, entries, {
    ...
    // wxt.config.ts declares options_ui with open_in_tab: false, so this opens the browser's own
    // small options dialog rather than a full tab; openOptionsPage is the one API that works
    // correctly either way, unlike building a chrome-extension:// url and navigating to it by hand.
